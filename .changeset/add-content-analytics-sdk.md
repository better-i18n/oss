...
Initial release of the Content Analytics SDK. Track content views with framework adapters for Next.js, React, Expo, Svelte, Vue, and vanilla JS. Writes go to `content.better-i18n.com/v1/track`, ingested into Cloudflare Analytics Engine, queryable from the Better i18n dashboard.
