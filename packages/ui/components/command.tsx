...
function CommandInput({
  ...
  return (
    ...
    >
      <IconMagnifyingGlass className="me-2 h-4 w-4 shrink-0 opacity-50" />
...
interface ButtonArrowProps extends ComponentProps<typeof IconCheckmark1> {
  icon?: typeof IconCheckmark1; // Allows passing any Central icon
}

function CommandCheck({
  icon: Icon = IconCheckmark1,
  className,
  ...props
}: ButtonArrowProps) {
  return (
