          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center">
                <IconExclamationCircle className="size-3.5 text-destructive" />
              </div>
            </TooltipTrigger>
            <TooltipContent>
              ...
              <CommandGroup heading={field.label || "Selected"}>
                {selectedOptions.map((option) => (
                  ...
                  >
                    ...
                    <IconCheckmark1 className="text-primary ms-auto" />
                  </CommandItem>
                ))}
              </CommandGroup>
            )}
                ...
                <CommandGroup>
                  {unselectedOptions.map((option) => (
                    ...
                    >
                      ...
                      <IconCheckmark1 className="text-primary ms-auto opacity-0" />
                    </CommandItem>
                  ))}
                </CommandGroup>
              </>
