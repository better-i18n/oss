...
- Updated dependencies [7393bf8]
  - @better-i18n/core@0.14.2

## 0.9.2

### Patch Changes

- Updated dependencies [a994610]
  - @better-i18n/core@0.14.1
...
- 0214757: `initBetterI18n` and `BetterI18nBackend` now accept `projectId` as the canonical project field, matching the "Project ID" shown in the dashboard and the Content SDK. `project` keeps working as a deprecated alias.
...
- Updated dependencies [5522999]
  - @better-i18n/core@0.11.0
...
- fc5fbc1: Add reactive `useLanguages()` hook and `refreshLanguages()` to prevent empty language list on fast cold starts
...
- 01f77f9: Fix widget gallery showing stale language after language change
