...
export const i18n = createServerI18n({
  projectId: "my-org/my-project", // your Better i18n project
  defaultLocale: "en",
});
```
</Step>
...
Pair with the provider's [`localeCookie`](/frameworks/provider#locale-persistence) prop — same cookie name on both sides:
...
<Callout type="tip">
  **Seed all keys with AI.** Copy the prompt below into Claude, ChatGPT, or any AI agent with the [Better i18n MCP server](/mcp) connected:
