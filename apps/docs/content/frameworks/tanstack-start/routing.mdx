...
export const Route = createFileRoute("/")({
  beforeLoad: ({ context }) => { // [!code highlight]
    throw redirect({ // [!code highlight]
      to: "/$locale", // [!code highlight]
      params: { locale: context.locale || i18nConfig.defaultLocale }, // [!code highlight]
    }) // [!code highlight]
  },
})
```
