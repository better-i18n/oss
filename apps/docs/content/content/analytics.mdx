...
See [Data Model](/content/analytics-data-model) for the full schema.
...
- [API Reference](/content/analytics-api) — full surface area: `track()`, `useTrackView()`, options
- [Data Model](/content/analytics-data-model) — blob/double mapping, what's stored where
