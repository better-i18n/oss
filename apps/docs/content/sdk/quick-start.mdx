...
| --- | --- | --- | --- | --- |
| `projectId` | `string` | Yes | — | Project ID — accepts `org/project` slug or canonical UUID. Find both in dashboard Settings → General → Project ID. |
...
- [Models & Entries](/sdk/models) — define schema in dashboard + query with chainable `from()` API
- [REST API](/sdk/api-reference) — raw HTTP for any framework
