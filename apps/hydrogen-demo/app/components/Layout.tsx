  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <footer className="border-t border-stone-200 bg-white">
        <div className="page-frame grid grid-cols-1 divide-y divide-stone-100 sm:grid-cols-[1fr_auto] sm:divide-x sm:divide-y-0">
          {/* Left: brand */}
          ...
          {/* Right: links */}
          <div className="grid grid-cols-2 gap-8 py-10 sm:pl-12">
            <div>
