...
export const Route = createFileRoute("/_archived/audience/for-content-teams")({
  loader: ({ params, context }) => personaLoader("for-content-teams", params.locale, context.locales),
