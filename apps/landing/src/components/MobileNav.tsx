          ...
          <>
            ...
            >
              ...
              >
                  ...
                  >
                    <div className="space-y-1 pb-1">
                      ...
                      <div className="grid grid-cols-2 gap-1">
                        {[
                          {
                            to: "/$locale/i18n/react/" as const,
                            label: "React",
                          },
                          {
                            to: "/$locale/i18n/nextjs/" as const,
                            label: "Next.js",
                          },
                          {
                            to: "/$locale/i18n/vue/" as const,
                            label: "Vue",
                          },
                          {
                            to: "/$locale/i18n/nuxt/" as const,
                            label: "Nuxt",
                          },
                          {
                            to: "/$locale/i18n/angular/" as const,
                            label: "Angular",
                          },
                          {
                            to: "/$locale/i18n/svelte/" as const,
                            label: "Svelte",
                          },
                        ].map((item) => (
                          <Link
                ...
                {/* Bottom section: Language switcher only */}
