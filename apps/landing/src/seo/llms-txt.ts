...
const ENGLISH_PAGE_TITLES: Readonly<Record<string, string>> = {
  ...
  "i18n/vite": "Vite i18n Guide", "i18n/hono": "Hono i18n Guide", "i18n/rust": "Rust i18n Guide", "i18n/remix-hydrogen": "Remix & Hydrogen i18n Guide",
...
const ENGLISH_PAGE_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  "i18n/hono": "Hono internationalization: one middleware detects the request locale and injects a translator into every route handler.",
  "i18n/rust": "Rust internationalization without an SDK — read the same CDN JSON with reqwest and serde_json, or use the REST API.",
...
const STATIC_SECTIONS: readonly LlmsTxtSectionDef[] = [
  ...
  },
  {
    ...
    paths: [
      ...
      "i18n/tanstack-start", "i18n/vite", "i18n/hono", "i18n/rust", "i18n/remix-hydrogen",
